...
# Load all row data
alldataC50 <- read.csv("WA_Fn-UseC_-HR-Employee-Attrition-Updated-Cleaned-SelectedFeatures.csv", header = TRUE)
...
## 85.37% accurate - No discernable improvement after removing the features.
